...
#
# Source0 file verified with key 0xCCC4F07FAC641EFF (daniels@collabora.com)
#
Name     : wayland-protocols
Version  : 1.33
Release  : 41
URL      : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.33/downloads/wayland-protocols-1.33.tar.xz
Source0  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.33/downloads/wayland-protocols-1.33.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.33/downloads/wayland-protocols-1.33.tar.xz.sig
...
%prep
%setup -q -n wayland-protocols-1.33
cd %{_builddir}/wayland-protocols-1.33
pushd ..
cp -a wayland-protocols-1.33 build32
popd
pushd ..
cp -a wayland-protocols-1.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708271260
