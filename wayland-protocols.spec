...
Source0  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.42/downloads/wayland-protocols-1.42.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.42/downloads/wayland-protocols-1.42.tar.xz.sig
...
%setup -q -n wayland-protocols-1.42
cd %{_builddir}/wayland-protocols-1.42
pushd ..
cp -a wayland-protocols-1.42 build32
popd
pushd ..
cp -a wayland-protocols-1.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742825021
