...
Version  : 1.8
Release  : 6
URL      : https://wayland.freedesktop.org/releases/wayland-protocols-1.8.tar.xz
Source0  : https://wayland.freedesktop.org/releases/wayland-protocols-1.8.tar.xz
...
%prep
%setup -q -n wayland-protocols-1.8
pushd ..
cp -a wayland-protocols-1.8 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1497273899
