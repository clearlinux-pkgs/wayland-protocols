...
Source0  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.37/downloads/wayland-protocols-1.37.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.37/downloads/wayland-protocols-1.37.tar.xz.sig
...
%setup -q -n wayland-protocols-1.37
cd %{_builddir}/wayland-protocols-1.37
pushd ..
cp -a wayland-protocols-1.37 build32
popd
pushd ..
cp -a wayland-protocols-1.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725101613
