...
Source0  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.39/downloads/wayland-protocols-1.39.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.39/downloads/wayland-protocols-1.39.tar.xz.sig
...
%setup -q -n wayland-protocols-1.39
cd %{_builddir}/wayland-protocols-1.39
pushd ..
cp -a wayland-protocols-1.39 build32
popd
pushd ..
cp -a wayland-protocols-1.39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735117901
