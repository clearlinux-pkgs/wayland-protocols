...
Source0  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.34/downloads/wayland-protocols-1.34.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.34/downloads/wayland-protocols-1.34.tar.xz.sig
...
%prep
%setup -q -n wayland-protocols-1.34
cd %{_builddir}/wayland-protocols-1.34
pushd ..
cp -a wayland-protocols-1.34 build32
popd
pushd ..
cp -a wayland-protocols-1.34 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710976062
